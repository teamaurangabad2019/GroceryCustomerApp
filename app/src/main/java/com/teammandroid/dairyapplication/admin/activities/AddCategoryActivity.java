...
public class AddCategoryActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_submit:
                ...
                if (titlename.length() == 0 || msg.length() == 0) {
                    ...
                    Toast.makeText(AddCategoryActivity.this, "Please Enter All Details", Toast.LENGTH_SHORT).show();
                } else {
                   ...
                   AddMessageWithFile(0,fullpath,titlename,msg);
            ...
            if (requestCode == PICK_IMAGE_REQUEST) {
               ...
               if (data.getData() != null)
               {
                    ...
                    if(fullpath.endsWith("jpg") || fullpath.endsWith("jpeg")  || fullpath.endsWith("png"))
                    {
                        ...
                        Toast.makeText(AddCategoryActivity.this, "Select only images", Toast.LENGTH_SHORT).show();
                    }
            ...
            AndroidNetworking.upload(Constants.URL_CATEGORY)
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            Utility.launchActivity(AddCategoryActivity.this, CategoryListActivity.class, true);
                        }
    ...
    public void EnableRuntimePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(AddCategoryActivity.this,
                Manifest.permission.READ_EXTERNAL_STORAGE)) {

            Toast.makeText(AddCategoryActivity.this, "Storage permission allows us to Access Storage", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(AddCategoryActivity.this, new String[]{
